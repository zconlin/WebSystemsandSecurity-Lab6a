...
2. Add 4 new routes:
    ...
    > Hint: Check what the information you used in Lab 6A for the HTTP request to see what data and headers you need to use.
    - `.post('/')`
...
- [ ] 10 Points - `.env` file is not found on GitHub
